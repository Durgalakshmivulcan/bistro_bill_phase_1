...
const TABLE_COLUMNS = [
  ...
  { key: "cgst", label: "CGST 2.5%" },
  { key: "sgst", label: "SGST 2.5%" },
  { key: "igst", label: "IGST 2.5%" },
...
const SalesByTransaction = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const response = await getSalesTransactions(startDate, endDate, branchId, channel);
  ...
  return (
    <div className="mx-3 md:mx-4 mt-4 space-y-4">
      ...
      {/* Content */}
      {loading && <div className="text-center py-8 text-bb-textSoft">Loading sales transactions...</div>}
