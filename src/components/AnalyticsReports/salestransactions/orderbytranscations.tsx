...
const TABLE_COLUMNS = [
  ...
  { key: "orderType", label: "Normal/Advance Order" },
];
...
const OrderByTransaction = () => {
  const [tableData, setTableData] = useState<SalesTransactionRow[]>([]);
  ...
  }, [dateFilter, selectedBranch, optionFilter]);
...
export default OrderByTransaction;
