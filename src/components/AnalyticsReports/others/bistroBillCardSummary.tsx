...
export default function BistroBillCardSummary() {
...
{/* 
      ...
      <div className="flex flex-col sm:flex-row flex-wrap justify-end gap-2">
        ...
        <Dropdown
          ...
          multi
          options={[
            "Bistro Bill Card Transaction Mode",
            "Type",
            "Total Amount",
            "Branch",
            "Branch Code",
      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-x-auto">
        <div className="min-w-[900px]">
          ...
          <div
            ...
            style={{
              gridTemplateColumns: "350px 150px 150px 150px 120px",
            }}
          >
            <div>Bistro Bill Card Transaction Mode</div>
            <div>Type</div>
          ...
          {[
            {
              mode: "Bistro Bill Card Transaction Mode",
              type: "Type",
              amount: "₹ 250",
              branch: "-",
              code: "001",
