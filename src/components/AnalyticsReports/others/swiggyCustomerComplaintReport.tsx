...
export default function SwiggyCustomerComplaintReport() {
    ...
    <div className="mx-3 md:mx-4 space-y-4">
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <h2 className="text-lg md:text-xl font-semibold text-bb-text">
          Swiggy Customer Complaint Report
        </h2>
      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-x-auto">
        <div className="min-w-[3500px]">
          ...
          <div
            ...
            style={{
              gridTemplateColumns: `
                140px 120px 120px 120px 140px 160px 120px 120px 120px 120px
                140px 140px 140px 140px 160px 160px 160px 140px 140px 160px
                160px 160px 180px 180px
              `,
            }}
          >
            {[
              ...
              "Addons",
              "Variants",
              "Unresolved Complaint Risk Input",
              "Created at",
              "Expired at",
              "Image URL",
              "Customer Comments",
