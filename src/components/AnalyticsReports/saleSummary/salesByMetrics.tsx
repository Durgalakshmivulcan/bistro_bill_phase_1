...
export default function SalesSummaryByMetrics() {
  return (
  ...
  <ReportActions />
      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-x-auto">
        <div className="min-w-[900px]">
          {/* Table Header */}
          <div className="grid grid-cols-6 bg-[#F7C948] text-black px-4 py-2 text-sm font-medium">
            <div>Brand</div>
          ...
          {Array.from({ length: 16 }).map((_, i) => (
            ...
            >
              <div>Solitary</div>
              <div>{i % 2 === 0 ? "Session" : "Source"}</div>
              <div>{i % 2 === 0 ? "Unknown" : "POS"}</div>
              <div>30</div>
              <div>1</div>
              <div>30</div>
            </div>
